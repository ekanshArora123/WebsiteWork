...
$locationsHTML .= "<div class='form-row'>
				<div class='form-group col-sm-3'>
					<select name='locationType' id='locationType' class='form-control' onChange = updateLocation(locationType.value) >";
...
$locationSelectBoxLabel = $_SESSION["location"];
if(!isset($_SESSION["location"]) || $_SESSION["location"] == 'all') {
	$locationSelectBoxLabel = "All";
}

//finishes location dropdown
$locationsHTML .= "<option value = 'all'>all</option> 
				<option value = '".$_SESSION["location"]."' selected>".$locationSelectBoxLabel."</option>
					 </select>
				</div>
			</div>";
